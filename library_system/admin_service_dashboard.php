...
<html>
    ...
    <style>
        body{
    background:linear-gradient(rgba(0, 0, 0, 0.25),rgb(0, 0, 0,0.25)), url("image/library.jpg") no-repeat;
...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="image/logo.png" height="120px" /></div>
            <div class="leftinnerdiv">
                <Button class="greenhead"> ADMIN</Button>
            ...
            <Button class="greenhead" >BOOK REQUEST APPROVE</Button>
            ...
            <Button class="greenhead" >ADD NEW BOOK</Button>
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="IT"/>IT<div style="margin-left:80px"><input type="radio" name="branch" value="ENGLISH"/>ENGLISH<input type="radio" name="branch" value="ENGINEERING"/>ENGINEERING</div>
            </div>   
            ...
            <Button class="greenhead" >ADD PERSON</Button>
            ...
            <Button class="greenhead" >USER RECORD</Button>
            ...
            <Button class="greenhead" >ISSUE BOOK RECORD</Button>
...
issue book -->
            ...
            <Button class="greenhead" >ISSUE BOOK</Button>
...
<br>
            ...
            <Button class="greenhead" >BOOK DETAIL</Button>
</br>
<?php
            $u=new data;
            $u->setconnection();
...
?>
            ...
            <Button class="greenhead" >BOOK RECORD</Button>
            <?php
            $u=new data;
            $u->setconnection();
            $u->getbook();
